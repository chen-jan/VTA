...
# VTA multi-stock demo (conditional reasoning guidance enabled)
...
echo "VTA multi-stock demo (single configuration, conditional reasoning guidance enabled)"
...
# Construct Model ID
MODEL_ID="vta_DEMO_MULTI_cfg_lr${LR_FORMATTED}_align${ALIGNMENT_TYPE}_stats${LOSS_STATS_SANITIZED}_gs${GS_FORMATTED}_puncond${P_UNCOND_FORMATTED}"
